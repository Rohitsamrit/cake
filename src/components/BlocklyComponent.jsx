...
const BlocklyComponent = () => {
  ...
  const generateCode = () => {
    ...
    //   'Python'
    // );
    const jsCode = javascriptGenerator.workspaceToCode(blocklyRef.current, {
      blockToCode: (block) =>
        javascriptGenerator[block.type].call(block, block),
    });

    const pythonCode = pythonGenerator.workspaceToCode(blocklyRef.current, {
