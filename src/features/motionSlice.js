...
const initialState = {
  // Initial state of the cake process
};
...
export const cakeSlice = createSlice({
  ...
  initialState,
  reducers: {
    // Define reducers for cake-related actions here
    // For example:
    addIngredient: {
      reducer: (state, action) => {
        // Logic to add an ingredient to the cake process
    ...
    mixIngredients: {
      reducer: (state, action) => {
        // Logic to mix the ingredients for the cake process
        console.log("Mixieeee");
        return state;
      },
    },
    bakeCake: {
      reducer: (state, action) => {
        // Logic to bake the cake for the specified duration
      },
      prepare: (minutes) => ({ payload: { minutes } }),
    },
    getMix: {
      reducer: (state, action) => {
        // Logic to retrieve the current mix of ingredients
        console.log("Mixieee");
      },
    },
    resetCake: {
      reducer: (state, action) => {
        // Logic to reset the cake process
      },
    },
  },
});
...
export const { addIngredient, mixIngredients, bakeCake, getMix, resetCake } =
  cakeSlice.actions;
